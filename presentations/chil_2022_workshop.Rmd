...
1. Decision points, $t$ (Times at which an intervention can be provided)
  - Regular intervals in time (e.g., every 10 minutes)
  - At user demand
- __HeartSteps__: Approximately every 2-2.5 hours at user-specific times labeled as monring, mid-day, mid-afternoon, early evening, after dinner
...
- Types of treatments that can be provided at a decision point, $t$

- {\bf HeartSteps}: tailored activity suggestion (yes/no)
...
__HeartSteps__: push or do not push tailed suggestion
  - $P(A_t = 1) = 0.6$ (push)
...
* {\bf Large number of stakeholders with differing data needs/interests}
